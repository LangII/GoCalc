...
class TaxiCabInflPanel (ContentPanel):
    board_size = NumericProperty()
    grid_star_size = NumericProperty()

    def __init__(self, **kwargs):
        super(TaxiCabInflPanel, self).__init__(title="Taxi Cab Infl Calc")
...
class TriggerInflCalc (PanelSettingsInput):
    ...
    def __init__(self):
        ...
        self.app = App.get_running_app()
        self.button = Button(text='do it', height=20)
        self.add_widget(self.button)

        self.button.bind(on_release=self.triggerInflCalcButton)

    def triggerInflCalcButton(self, *args):
        display_buttons = self.app.main.content_scroll.taxi_cab_infl_panel.display.buttons
